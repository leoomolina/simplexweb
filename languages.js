var translations =
{
	...
	"first_press_button_solve_lpp": { en_us: "First press the button 'Continue'.", pt_br: "Primeiro pressione o botão 'Continuar'."},
